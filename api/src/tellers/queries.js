...
const log_teller_info = "INSERT INTO teller(teller_id, t_arrival, t_depart, teller_log_codes), VALUES($1, $2, $3, $4)";
const update_log_info = "UPDATE teller SET t_depart=$1, WHERE teller_log_code=$2";
const get_all_teller_log = "SELECT * FROM teller";
const get_teller_sale = "SELECT product_id, product_qty, teller_id FROM sold";
const teller_report = "";
